...
object CountInstrumentation {
  def apply(system: ActorSystem): CountInstrumentation = Instrumentation[CountInstrumentation](system)
 ...
 */
class CountInstrumentation(config: Config) extends EmptyInstrumentation {
