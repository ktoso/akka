 ...
 * @see [[PersistentBatch]]
 */
@deprecated("UntypedProcessor will be removed. Instead extend `UntypedEventsourcedProcessor` and use it's `persistAsync(command)(callback)` method to get equivalent semantics.", since = "2.3.4")
 ...
 * @see [[PersistentBatch]]
 */
@deprecated("AbstractProcessor will be removed. Instead extend `AbstractEventsourcedProcessor` and use it's `persistAsync(command)(callback)` method to get equivalent semantics.", since = "2.3.4")
