 ...
 */
abstract class RemoteInstrumentation extends Instrumentation {
...
abstract class EmptyRemoteInstrumentation extends RemoteInstrumentation {
  ...
  override def remoteActorTold(actorRef: ActorRef, message: Any, sender: ActorRef): AnyRef = Instrumentation.EmptyContext
