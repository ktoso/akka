...
lazy val actor = akkaModule("akka-actor")
  ...
  // `akka` for historical compat, rather than `akka.actor`
  .settings(VersionGenerator.settings("akka", _ / "akka" / "Version.scala"))
...
lazy val agent = akkaModule("akka-agent")
  ...
  .settings(OSGi.agent)
  .settings(VersionGenerator.settings("akka.agent", _ / "akka" / "agent" / "Version.scala"))
...
lazy val camel = akkaModule("akka-camel")
  ...
  .settings(VersionGenerator.settings("akka.camel", _ / "akka" / "camel" / "Version.scala"))
  .settings(OSGi.camel)
...
lazy val cluster = akkaModule("akka-cluster")
  ...
  .settings(VersionGenerator.settings("akka.cluster", _ / "akka" / "cluster" / "Version.scala"))
...
lazy val clusterMetrics = akkaModule("akka-cluster-metrics")
  ...
  .settings(VersionGenerator.settings("akka.cluster.metrics", _ / "akka" / "cluster" / "metrics" / "Version.scala"))
  .settings(Protobuf.settings)
...
lazy val clusterSharding = akkaModule("akka-cluster-sharding")
  ...
  .settings(VersionGenerator.settings("akka.cluster.sharding", _ / "akka" / "cluster" / "sharding" / "Version.scala"))
...
lazy val clusterTools = akkaModule("akka-cluster-tools")
  ...
  .settings(VersionGenerator.settings("akka.cluster.tools", _ / "akka" / "cluster" / "tools" / "Version.scala"))
...
lazy val distributedData = akkaModule("akka-distributed-data")
  ...
  .settings(VersionGenerator.settings("akka.cluster.ddata", _ / "akka" / "cluster" / "ddata" / "Version.scala"))
...
lazy val multiNodeTestkit = akkaModule("akka-multi-node-testkit")
  ...
  .settings(VersionGenerator.settings("akka.remote.testkit", _ / "akka" / "remote" / "testkit" / "Version.scala"))
...
lazy val osgi = akkaModule("akka-osgi")
  ...
  .settings(VersionGenerator.settings("akka.osgi", _ / "akka" / "osgi" / "Version.scala"))
  .settings(OSGi.osgi)
  .settings(
    parallelExecution in Test := false
  )
...
lazy val persistence = akkaModule("akka-persistence")
  ...
  .settings(VersionGenerator.settings("akka.persistence", _ / "akka" / "persistence" / "Version.scala"))
...
lazy val persistenceQuery = akkaModule("akka-persistence-query")
  ...
  .settings(VersionGenerator.settings("akka.persistence.query", _ / "akka" / "persistence" / "query" / "Version.scala"))
...
lazy val persistenceShared = akkaModule("akka-persistence-shared")
  ...
  .settings(VersionGenerator.settings("akka.persistence.shared", _ / "akka" / "persistence" / "shared" / "Version.scala"))
  .settings(
    fork in Test := true
  )
  .enablePlugins(NoPublish)
...
lazy val persistenceTck = akkaModule("akka-persistence-tck")
  ...
  .settings(VersionGenerator.settings("akka.persistence.tck", _ / "akka" / "persistence" / "tck" / "Version.scala"))
...
lazy val protobuf = akkaModule("akka-protobuf")
  ...
  .settings(VersionGenerator.settings("akka.protobuf", _ / "akka" / "protobuf" / "Version.scala"))
  .enablePlugins(ScaladocNoVerificationOfDiagrams)
  .disablePlugins(MimaPlugin)
...
lazy val remote = akkaModule("akka-remote")
  ...
  .settings(VersionGenerator.settings("akka.remote", _ / "akka" / "remote" / "Version.scala"))
...
lazy val slf4j = akkaModule("akka-slf4j")
  ...
  .settings(VersionGenerator.settings("akka.slf4j", _ / "akka" / "slf4j" / "Version.scala"))
  .settings(OSGi.slf4j)
...
lazy val stream = akkaModule("akka-stream")
  ...
  .settings(VersionGenerator.settings("akka.stream", _ / "akka" / "stream" / "Version.scala"))
...
lazy val streamTestkit = akkaModule("akka-stream-testkit")
  ...
  .settings(VersionGenerator.settings("akka.stream.testkit", _ / "akka" / "stream" / "testkit" / "Version.scala"))
...
lazy val testkit = akkaModule("akka-testkit")
  ...
  .settings(VersionGenerator.settings("akka.actor.testkit", _ / "akka" / "actor" / "testkit" / "Version.scala"))
...
lazy val actorTyped = akkaModule("akka-actor-typed")
  ...
  .settings(VersionGenerator.settings("akka.actor.typed", _ / "akka" / "actor" / "typed" / "Version.scala"))
  .settings(
    initialCommands := """
...
lazy val persistenceTyped = akkaModule("akka-persistence-typed")
  ...
  .settings(VersionGenerator.settings("akka.persistence.typed", _ / "akka" / "persistence" / "typed" / "Version.scala"))
  .disablePlugins(MimaPlugin)
...
lazy val clusterTyped = akkaModule("akka-cluster-typed")
  ...
  .settings(VersionGenerator.settings("akka.cluster.typed", _ / "akka" / "cluster" / "typed" / "Version.scala"))
  .disablePlugins(MimaPlugin)
...
lazy val clusterShardingTyped = akkaModule("akka-cluster-sharding-typed")
  ...
  .settings(VersionGenerator.settings("akka.cluster.sharding.typed", _ / "akka" / "cluster" / "sharding" / "typed" / "Version.scala"))
...
lazy val streamTyped = akkaModule("akka-stream-typed")
  ...
  .settings(VersionGenerator.settings("akka.stream.typed", _ / "akka" / "stream" / "typed" / "Version.scala"))
  .disablePlugins(MimaPlugin)
  .enablePlugins(ScaladocNoVerificationOfDiagrams)
...
lazy val typedTestkit = akkaModule("akka-testkit-typed")
  ...
  .settings(VersionGenerator.settings("akka.testkit.typed", _ / "akka" / "testkit" / "typed" / "Version.scala"))
