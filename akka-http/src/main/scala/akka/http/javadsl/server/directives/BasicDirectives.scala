...
import akka.http.javadsl.model.{ HttpResponse, StatusCode }
import akka.http.javadsl.server._

import scala.annotation.varargs
import scala.concurrent.Future

abstract class BasicDirectives extends BasicDirectivesBoilerplate {
  /**
   ...
   */
  @varargs
  def handleWithReflect(instance: AnyRef, methodName: String, extractions: RequestVal[_]*): Route =
    handleWithReflect(instance.getClass, instance, methodName, extractions: _*)
   ...
   */
  @varargs
  def handleWithReflect(clazz: Class[_], methodName: String, extractions: RequestVal[_]*): Route =
    handleWithReflect(clazz, null, methodName, extractions: _*)
   ...
   */
  @varargs
  def handleWithReflect(clazz: Class[_], instance: AnyRef, methodName: String, extractions: RequestVal[_]*): Route = {
